...
export const PSO_LEVY_EUR_PER_MONTH_INC_VAT = PSO_LEVY_EUR_PER_MONTH_EX_VAT * VAT_RESIDENTIAL;
...
export const GAS_CARBON_TAX_EUR_PER_KWH_INC_VAT = GAS_CARBON_TAX_EUR_PER_KWH_EX_VAT * VAT_RESIDENTIAL;
